"""
ai_service/rag/pipeline.py — LangGraph StateGraph Router for dynamic RAG execution.
"""
...
from ai_service.rag.agents.news_agent import run_news_agent
from ai_service.rag.prompts import ROUTER_INTENT_CLASSIFIER_PROMPT
from ai_service.rag.schemas import RAGResponse
...
def execute_rag_pipeline(question: str, article_id: str | None = None) -> RAGResponse:
    ...
    return RAGResponse(
        ...
        model_used=final_state.get("model_used", "gpt-5-mini"),
    )
