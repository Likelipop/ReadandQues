"""
service/infrastructure/bm25/index.py — Lexical search and highlight marker querying using BM25.
"""
...
def extract_markers_text(markdown_text: str) -> str:
    """
    Extract text enclosed in standard markdown highlight markers (==example==).
    """
...
def find_related_by_markers(
    ...
    """
    Find related articles matching user highlights in an article.
    """
